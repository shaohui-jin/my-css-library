<template>
  <div class="checked-body">
    ...
    <svg width="200" height="200">
      <circle class="circle" fill="none" r="50" stroke="#68e534" stroke-width="10" cx="50" cy="50" stroke-linecap="round" transform="rotate(-90 200 200)" />
